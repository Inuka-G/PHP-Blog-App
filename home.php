...
<div class="blogContents grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 m-8">

    
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="rounded-t-lg" src="https://cdn.stocksnap.io/img-thumbs/280h/maple-tree_DEMD7LUNBV.jpg" alt="" />
        </a>
        <div class="p-5">
            <a href="#">
            ...
            <a href="/phpblog/singleblog" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Read more
